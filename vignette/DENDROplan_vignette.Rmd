...
In addition to *DENDRO* package, we also needed to download the reference RNA-seq dataset.
...
knitr::include_graphics("../figure/Pkg_FIG-02.tif")
```
...
```{r, out.width = "1000px", fig.align = "center", echo=FALSE}
knitr::include_graphics("../figure/Pkg_FIG-03.tif")
```
...
* Adjust Rand index: Adjusted Rand index is a measure of the similarity between two data clusterings after adjusted for the chance grouping of elements. For details, see [here](https://en.wikipedia.org/wiki/Rand_index)
...
```{r, out.width = "1000px", fig.align = "center", echo=FALSE}
knitr::include_graphics("../figure/deng_stat-04.tiff")
```

  **Figure 4**. scRNA-seq library statistics for Deng et al. Modified from [original paper](http://science.sciencemag.org/content/sci/suppl/2014/01/09/343.6167.193.DC1/Deng-SM.pdf).
