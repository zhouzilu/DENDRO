  ...
  sidebarLayout(
    ...
    mainPanel(
       h4(p("This app is mean to guide researcher on experimental design using Smart-seq2
         ...
         ', which is a embryo development dataset. In tumor-related experiment, this estimation 
         may not be perfect. We always recommend ',
       ...
       h5(p(strong("Detection probability:")," Probability that you detect this subclone given 100 permutation."),
          p(strong("Capture rate:")," Capture rate of the variable red clade, i.e. out of all the cells from the 
            red clade, how many of them is detected by the algorithm"),
          p(strong("Purity:")," Purity of the variable red cluster, i.e. out of the \'red cluster\' 
            you detected, how many are actually from the true red clade"),
          p(strong("Adjusted Rand Index:")," Adjusted Rand index is a measure of the similarity between two 
